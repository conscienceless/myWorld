    ...
    public class BlockEditor : EditorWindow
    {
        ...
        public void OnGUI()
        {
            ...
            if (SelectedBlock != null)
            {
                ...
                //textureUnit
                selectedVoxel.VTextureUnit = EditorGUILayout.FloatField("TextureUnit", selectedVoxel.VTextureUnit);
                ...
                if (GUILayout.Button("Apply", GUILayout.Height(30)))
                {
                    ...
                    if (SelectedPrefab != null
                        ...
                        && GetBlock(selectedVoxel.GetID()) != null)
        ...
        { // gets all valid voxel prefabs and applies them to the lBlocks array in the Engine GameObject
