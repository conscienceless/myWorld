...
namespace Uniblocks
{
    ...
    public class Engine : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            StreamReader sr = new StreamReader(Application.dataPath + "/Resources/settings.txt");
            WorldName = sr.ReadLine();
        ...
        {
            WorldPath = Application.dataPath + "/Resources/Worlds/" + Engine.WorldName + "/"; // you can set World Path here
        ...
        public static float GetTextureUnit(ushort voxel)
        {
            float unit;
            Voxel voxelType = Engine.GetVoxelType(voxel);
            unit = voxelType.VTextureUnit;
            return unit;
        }
    }
